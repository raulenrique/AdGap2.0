...
class Listings extends DatabaseModel
{
	...
	protected static $validationRules = [
									"category"    => "inputValidate, minlength:1",
									"title"       => "inputValidate, minlength:1",
									"buyNowPrice" => "inputValidate, numeric",
									"location"    => "inputValidate, minlength:1",
									"description" => "inputValidate, minlength:10,maxlength:500",
	];
