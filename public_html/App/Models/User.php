...
class User extends DatabaseModel
{
	...
	protected static $validationRules = [
					"username" 		=> "inputValidate, minlength:1",
					"email" 		=> "inputValidate, email,unique:App\Models\User",
					"password" 		=> "inputValidate, minlength:6",
					"password2" 	=> "inputValidate, match:password"
